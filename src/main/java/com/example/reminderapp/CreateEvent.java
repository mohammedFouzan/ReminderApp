...
public class CreateEvent extends AppCompatActivity implements View.OnClickListener {
    ImageView btn_record, btn_done, btn_time, btn_date;
    ...
    private void submit() {
        ...
        if (text.isEmpty()) {
            ...
            if (btn_time.getTag().toString().equals("Select Time") || btn_date.getTag().toString().equals("Select date")) {
                Toast.makeText(this, "Please select date and time", Toast.LENGTH_SHORT).show();
            } else {
                EntityClass entityClass = new EntityClass();
                String value = (editext_message.getText().toString().trim());
                String date = (btn_date.getTag().toString().trim());
                String time = (btn_time.getTag().toString().trim());
    ...
    private void selectTime() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int i, int i1) {
                timeTonotify = i + ":" + i1;
                btn_time.setTag(FormatTime(i, i1));
            }
        }, hour, minute, false);
    ...
    private void selectDate() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                ...
                btn_date.setTag(day + "-" + (month + 1) + "-" + year);
            }
        }, year, month, day);
